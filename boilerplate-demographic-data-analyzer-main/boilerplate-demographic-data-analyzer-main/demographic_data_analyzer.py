...
def calculate_demographic_data(print_data=True):
    ...
    country_salary_counts = df.groupby("native-country")["salary"].count()
    ...
    country_rich_percentages = (country_rich_counts / country_salary_counts) * 100

    highest_earning_country = country_rich_percentages.idxmax()

    highest_earning_country_percentage = round(
        country_rich_percentages.max(),
        1
    )
